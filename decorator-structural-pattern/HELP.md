...
In order to deal with the problem of incompatible interfaces, **Decorator Pattern** allows convert the one incompatible into another that the client expects:
